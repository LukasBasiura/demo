...
https://docs.parasoft.com/display/JTEST20211/Integrating+with+Build+Systems
...
3. 运行以下命令来执行受更改影响的测试：
   mvnw clean cbt:affected-tests test -Dparasoft.coverage.file=tia/coverage.xml -Dparasoft.test.file=cbt/report.xml
   或
   gradlew clean affectedTests test -Dparasoft.coverage.file=tia/coverage.xml -Dparasoft.test.file=cbt/report.xml
...
3. 运行以下命令来执行受更改影响的测试：
   ./mvnw clean cbt:affected-tests test -Dparasoft.coverage.file=tia/coverage.xml -Dparasoft.test.file=tia/report.xml
   或
...
有关更多详情，请查阅 https://docs.parasoft.com/display/JTEST20211/Application+Coverage
